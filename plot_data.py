...
with open('/home/adriel/Documents/GRIEF-DE/results/michigan/exp1/convergence.txt') as f:
    lines = f.readlines()

y_GRIEF_DE_NOSEL1 = [int(x) for x in lines]

with open('/home/adriel/Documents/GRIEF-DE/results/michigan/exp2/convergence.txt') as f:
    lines = f.readlines()

y_GRIEF_DE_NOSEL2 = [int(x) for x in lines]

#with open('/home/adriel/Documents/GRIEF-DE/results/michigan/exp3/convergence.txt') as f:
#    lines = f.readlines()
#
#y_GRIEF_DE_NOSEL3 = [int(x) for x in lines]
#
#with open('/home/adriel/Documents/GRIEF-DE/results/michigan/exp4/convergence.txt') as f:
#    lines = f.readlines()
#
#y_GRIEF_DE_NOSEL4 = [int(x) for x in lines]

#with open('/home/adriel/Documents/GRIEF-DE/results/michigan/exp5/convergence.txt') as f:
#    lines = f.readlines()
#
...
y_GRIEF_DE_NOSEL =[x / 4 for x in grief_data]
...
#
#y_GRIEF_DE =[x / 5 for x in grief_data]
...
with open('/home/adriel/Documents/GRIEF-DE/results/michigan/exp1/all_fits.txt') as f:
    lines = f.readlines()
...
for i in range(0,len(data),2):
    result.append(max(data[:i+1]))
#
#with open('/home/adriel/Documents/GRIEF-DE/results/michigan/exp2/all_fits.txt') as f:
#    lines = f.readlines()
#
#count = 0
#data = []
...
#
#with open('/home/adriel/Documents/GRIEF-DE/results/michigan/exp3/all_fits.txt') as f:
#    lines = f.readlines()
#
#count = 0
#data = []
...
#
#with open('/home/adriel/Documents/GRIEF-DE/results/michigan/exp4/all_fits.txt') as f:
#    lines = f.readlines()
#
#count = 0
#data = []
...
#grief_data = list( map(add, result2, result3))
...
count = 0
for i,x in enumerate(list_files):
    list_numeration.append(x.split("_")[0])
    
    list_fit.append(x.split("_")[1])
    count+=1

for i,x in enumerate(list_fit):
    if(x == ""):
        print(i)
aux = [int(x) for x in list_fit]
y_order = [int(x) for x in list_numeration]
