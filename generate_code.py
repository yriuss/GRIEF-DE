...
for byte in range(bytes):
    ...
    for i in range(8):
        ...
        print ("((SMOOTHED(individual[" + str(byte*8 + i) + "][" + str(1) + "], individual[" + str(byte*8 + i) + "][" + str(0) + "]) < SMOOTHED(individual[" + str(byte*8 + i) + "][" + str(3) + "], individual[" + str(byte*8 + i) + "][" + str(2) + "])) << " + str(7-i) + ")")
        if i == 7:
            print (';')
        else:
            print ('+',)
